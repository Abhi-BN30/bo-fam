...
export default function ChoiceModal({ isOpen, currentUser, onClose, onSelectAddSelf, onSelectAddOther }: ChoiceModalProps) {
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] p-4">
      <div className="bg-white p-6 sm:p-8 rounded-2xl w-full sm:w-96 shadow-2xl max-h-[90vh] overflow-auto">
        ...
        <p className="text-gray-600 mb-4 sm:mb-6 text-center text-xs sm:text-sm">
          Would you like to add yourself to the family tree or add another family member?
        </p>
